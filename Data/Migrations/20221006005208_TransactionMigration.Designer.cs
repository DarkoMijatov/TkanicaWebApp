...
namespace TkanicaWebApp.Data.Migrations
{
    ...
    [Migration("20221006005208_TransactionMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TkanicaWebApp.Models.Creditor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TkanicaWebApp.Models.Debtor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TkanicaWebApp.Models.AccountNumber", b =>
                {
                    b.HasOne("TkanicaWebApp.Models.Creditor", "Creditor")
                        .WithMany("AccountNumbers")
                        .HasForeignKey("CreditorId");

                    b.HasOne("TkanicaWebApp.Models.Debtor", "Debtor")
                        .WithMany("AccountNumbers")
